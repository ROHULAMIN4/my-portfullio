      ...
      <div className="col-lg-6 col-sm-12">
        ...
        <p className="details">
          <i>
            ...
            detailed-oriented, front-end web developer. As you'll see. I have a
            few months of hands-on experience efficiently coding websites and
            applications using modern HTML5, CSS3, JavaScript, React js,
            MongoDB, node js, firebase. Building state-of-the-art, easy-to-use,
